...
<body>
    <div id="root" class="layout-container page-recharge-public">
        <header class="layout-navbar">
            <nav class="navbar navbar-expand-lg bg-primary">
                <div class="container-fluid align-items-center px-0">
                    ...
                    <p class="navbar-title mb-0">Transfer To Flexible Account</p>
                ...
                <div class="form-wrap">
                    ...
                    <div class="address-wrap">
                        <div class="input-group head">
                            <input type="text" class="form-control" aria-label="transaction-link" aria-describedby="transaction-link" readonly="readonly" />
                            <button class="btn btn-primary copy-btn" type="button" id="transaction-link">Copy</button>
                        </div>
                        <div class="foot">
